...
/**
    ...
    public function createForDirectDebitWithAccountIdRequest($direct_debit_with_account_details, string $contentType = self::contentTypes['createForDirectDebitWithAccountId'][0])
    {
        ...
        if (isset($direct_debit_with_account_details)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($direct_debit_with_account_details));
            } else {
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\Error|\OpenAPI\Client\Model\Error|\OpenAPI\Client\Model\Error|\OpenAPI\Client\Model\Error|\OpenAPI\Client\Model\ValidationError|\OpenAPI\Client\Model\Error|\OpenAPI\Client\Model\WebForm
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\Error|\OpenAPI\Client\Model\Error|\OpenAPI\Client\Model\Error|\OpenAPI\Client\Model\Error|\OpenAPI\Client\Model\ValidationError|\OpenAPI\Client\Model\Error|\OpenAPI\Client\Model\WebForm, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    public function createForPaymentWithAccountIdRequest($payment_with_account_details, string $contentType = self::contentTypes['createForPaymentWithAccountId'][0])
    {
        ...
        if (isset($payment_with_account_details)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($payment_with_account_details));
            } else {
    ...
    public function createForStandalonePaymentRequest($standalone_payment_details, string $contentType = self::contentTypes['createForStandalonePayment'][0])
    {
        ...
        if (isset($standalone_payment_details)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($standalone_payment_details));
            } else {
    ...
    public function createForStandingOrderRequest($standing_order_details, string $contentType = self::contentTypes['createForStandingOrder'][0])
    {
        ...
        if (isset($standing_order_details)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($standing_order_details));
            } else {
