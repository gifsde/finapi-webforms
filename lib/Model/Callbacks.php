 ...
 *
 * @category Class
 * @description Callbacks for the instantiated web form. Find more info in the &lt;a href&#x3D;&#39;https://documentation.finapi.io/webform/For-best-results!.2477654019.html#Forbestresults!-Enhanceyourexperience!&#39; target&#x3D;&#39;_blank&#39;&gt;Web Form 2.0 Public Documentation&lt;/a&gt;.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
    ...
    */
    ...
    public function setFinalised($finalised)
    {
        ...
        if (!is_null($finalised) && (mb_strlen($finalised) > 2048)) {
            throw new \InvalidArgumentException('invalid length for $finalised when calling Callbacks., must be smaller than or equal to 2048.');
        }
        if (!is_null($finalised) && (mb_strlen($finalised) < 0)) {
            throw new \InvalidArgumentException('invalid length for $finalised when calling Callbacks., must be bigger than or equal to 0.');
        }
        if (!is_null($finalised) && (!preg_match("/https:\/\/(www\\.)?[-a-zA-Z0-9@:%._+~#=]{1,256}\\.[a-zA-Z0-9()]{1,63}\\b([-a-zA-Z0-9()@:%_+.~#?&\/=]*)/", $finalised))) {
            throw new \InvalidArgumentException("invalid value for \$finalised when calling Callbacks., must conform to the pattern /https:\/\/(www\\.)?[-a-zA-Z0-9@:%._+~#=]{1,256}\\.[a-zA-Z0-9()]{1,63}\\b([-a-zA-Z0-9()@:%_+.~#?&\/=]*)/.");
        }
