 ...
 */
class EditProfileDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EditProfileDetails';
    ...
    */
     ...
     * Sets label
     *
     * @param string|null $label Label to profile.<br/>The label must be unique.
     *
     * @return self
     */
    public function setLabel($label)
    {
        ...
        if (!is_null($label) && (mb_strlen($label) > 128)) {
            throw new \InvalidArgumentException('invalid length for $label when calling EditProfileDetails., must be smaller than or equal to 128.');
        }
        if (!is_null($label) && (mb_strlen($label) < 0)) {
            throw new \InvalidArgumentException('invalid length for $label when calling EditProfileDetails., must be bigger than or equal to 0.');
        }
     ...
     * Sets default
     *
     * @param bool|null $default Whether the profile will be used by default for all web forms.<br/>We urge you to set one profile as default. This way, if you do not pass the profile in the API call, we will use the default profile from you for the web forms.<br/><br/>There can only be one default profile at one time.
     *
     * @return self
     */
