...
/**
 * ProfilesPage Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ProfilesPage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProfilesPage';
    ...
    protected static $openAPITypes = [
        'items' => '\OpenAPI\Client\Model\Profile[]',
    ...
    */
     ...
     * Sets items
     *
     * @param \OpenAPI\Client\Model\Profile[] $items Page of resources
     *
     * @return self
     */
    public function setItems($items)
    {
        ...
        if ((count($items) > 500)) {
            throw new \InvalidArgumentException('invalid value for $items when calling ProfilesPage., number of items must be less than or equal to 500.');
        }
        if ((count($items) < 0)) {
            throw new \InvalidArgumentException('invalid length for $items when calling ProfilesPage., number of items must be greater than or equal to 0.');
        }
