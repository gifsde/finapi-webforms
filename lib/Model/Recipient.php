    ...
    */
    ...
    public function setIban($iban)
    {
        ...
        if ((mb_strlen($iban) > 34)) {
            throw new \InvalidArgumentException('invalid length for $iban when calling Recipient., must be smaller than or equal to 34.');
        }
        if ((mb_strlen($iban) < 0)) {
            throw new \InvalidArgumentException('invalid length for $iban when calling Recipient., must be bigger than or equal to 0.');
        }
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 70)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Recipient., must be smaller than or equal to 70.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Recipient., must be bigger than or equal to 1.');
        }
