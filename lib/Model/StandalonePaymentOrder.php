 ...
 */
class StandalonePaymentOrder implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StandalonePaymentOrder';
    ...
    */
    ...
    public function setPurpose($purpose)
    {
        ...
        if (!is_null($purpose) && (mb_strlen($purpose) > 2000)) {
            throw new \InvalidArgumentException('invalid length for $purpose when calling StandalonePaymentOrder., must be smaller than or equal to 2000.');
        }
        if (!is_null($purpose) && (mb_strlen($purpose) < 1)) {
            throw new \InvalidArgumentException('invalid length for $purpose when calling StandalonePaymentOrder., must be bigger than or equal to 1.');
        }
    ...
    public function setSepaPurposeCode($sepa_purpose_code)
    {
        ...
        if (!is_null($sepa_purpose_code) && (!preg_match("/^[a-zA-Z0-9]{4}$/", $sepa_purpose_code))) {
            throw new \InvalidArgumentException("invalid value for \$sepa_purpose_code when calling StandalonePaymentOrder., must conform to the pattern /^[a-zA-Z0-9]{4}$/.");
        }
    ...
    public function setEndToEndId($end_to_end_id)
    {
        ...
        if (!is_null($end_to_end_id) && (mb_strlen($end_to_end_id) > 35)) {
            throw new \InvalidArgumentException('invalid length for $end_to_end_id when calling StandalonePaymentOrder., must be smaller than or equal to 35.');
        }
        if (!is_null($end_to_end_id) && (mb_strlen($end_to_end_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $end_to_end_id when calling StandalonePaymentOrder., must be bigger than or equal to 1.');
        }
