...
class Task implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets id
     *
     * @param string $id Globally unique task's identifier
     *
     * @return self
     */
    public function setId($id)
    {
        ...
        if ((mb_strlen($id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $id when calling Task., must be smaller than or equal to 36.');
        }
        if ((mb_strlen($id) < 36)) {
            throw new \InvalidArgumentException('invalid length for $id when calling Task., must be bigger than or equal to 36.');
        }
     ...
     * Sets created_at
     *
     * @param \DateTime $created_at The timestamp when the task was created in the format <code>yyyy-MM-dd'T'HH:mm:ss.SSSZ</code>.
     *
     * @return self
     */
