 ...
 */
class TranslationSetsPage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TranslationSetsPage';
    ...
    */
    ...
    public function setItems($items)
    {
        ...
        if ((count($items) > 500)) {
            throw new \InvalidArgumentException('invalid value for $items when calling TranslationSetsPage., number of items must be less than or equal to 500.');
        }
        if ((count($items) < 0)) {
            throw new \InvalidArgumentException('invalid length for $items when calling TranslationSetsPage., number of items must be greater than or equal to 0.');
        }
