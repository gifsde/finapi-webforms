...
class WebFormType
{
     ...
     */
    public const BANK_CONNECTION_IMPORT = 'BANK_CONNECTION_IMPORT';

    public const BANK_CONNECTION_UPDATE = 'BANK_CONNECTION_UPDATE';

    public const PAYMENT_WITH_ACCOUNT_ID = 'PAYMENT_WITH_ACCOUNT_ID';

    public const STANDALONE_PAYMENT = 'STANDALONE_PAYMENT';

    public const STANDING_ORDER = 'STANDING_ORDER';

    public const DIRECT_DEBIT_WITH_ACCOUNT_ID = 'DIRECT_DEBIT_WITH_ACCOUNT_ID';
    ...
    {
        return [
            self::BANK_CONNECTION_IMPORT,
            self::BANK_CONNECTION_UPDATE,
            self::PAYMENT_WITH_ACCOUNT_ID,
            self::STANDALONE_PAYMENT,
            self::STANDING_ORDER,
            self::DIRECT_DEBIT_WITH_ACCOUNT_ID
        ];
    }
}
